#
# Be sure to run `pod lib lint HPBaseKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'HPBaseKit'
  s.version          = '0.1.1'
  s.summary          = 'A short description of HPBaseKit.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'HPBaseKit/Classes/**/*'
  
  # s.resource_bundles = {
  #   'HPBaseKit' => ['HPBaseKit/Assets/*.png']
  # }
